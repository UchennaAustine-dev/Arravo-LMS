...
import { offSign, openToggle } from "../../redux/globalState";
...
const Signup = () => {
  ...
  const onHandleSubmit = handleSubmit(async (data: any) => {
    try {
      setLoading(true);
      const { emailAddress, fullName, password } = data;
      await registerAccount({ emailAddress, fullName, password }).then(
        (res: AxiosResponse) => {
      ...
      // Clear the console.log's i only used it for testing purposes
    ...
    <>
      <div className="w-full font-[poppins] fixed top-0 bg-black bg-opacity-90 z-[300] h-screen flex flex-col items-center justify-center">
        ...
        >
          ...
          <p className="w-[95%] text-center text-[13px]">
            Learn on your own time from top universities and businesses.
          </p>
          <div className="my-1" />
          {(errors.emailAddress || errors.fullName || errors.password) && (
            <div className="w-[80%] bg-[#ffc6ff] h-[60px] my-2 rounded-md flex items-center justify-center">
              <div className="w-[90%] flex items-center">
                ...
                <div className="text-[12px]">
                  ...
                  {errors.emailAddress && <p>Invalid email address</p>}
                  {errors.password && (
                    <p>Password must contain 7 - 30 characters</p>
                  )}
                </div>
              </div>
            </div>
          ...
          <div className="w-[80%] h-[45px] mt-8">
            ...
            <p className="text-[13px] mt-1">Between 7 - 30 characters</p>
            ...
            <div className="my-6" />
            <div className="w-[95%] flex items-center justify-center ">
              <div className="text-[13px] text-[gray] text-center ">
                I accept Coursera's{" "}
                <span className="underline">Terms of Use</span> and{" "}
                <span>Privacy Notice</span> apply.
              </div>
            </div>
            <div className="w-[95%] flex items-center justify-center ">
              <div className="text-[13px] text-[gray] mb-7">
